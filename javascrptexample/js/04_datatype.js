...
console.log(number1); //호이스팅 발생 : 선언은 위로 끌어올려지지만 값은 할당되지 않음
var number1 = 30;
console.log(number1);
console.log("----------------");
...
function typeTest(){
    ...
    typeBox.innerHTML += `<br />user.pwd : ${user.pwd} / ${typeof user.pwd}`;
    ...
    typeBox.innerHTML += `<br />sumFn(10, 20) : ${tempFn(30,  sumFn)}`;

    //아래 tempFn이 선언되어 있어야 오류가 나지 않는다.
