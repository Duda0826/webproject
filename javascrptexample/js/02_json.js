let bbs = {
    ...
    "items": [
        ...
        },
        {
            "no": 2,
            "subject": "HTML",
            "contents": "CSS는 웹페이지의 디자인을 담당하는 슽아일 시트 언어입니다. 레이아웃 구성, 색상, 폰트, 애니메이션 등을 설정할 수 있습니다.",
            "hit": 15,
            "date": "2025.03.17"
        },
        {
...
//bbsTitle에 innerHtml 방식으로 넣겠다. = bbs의 title을 title이 배열 형태니 join 사용하여 중간마다 / 넣어주는 방식
document.getElementById("bbsDescription").innerHTML = bbs.description;
//bbsDescription에 innerHtml 방식으로 넣겠다. = bbs의 Description을

bbs.items.forEach(item => { //bbs.items을 
    container.innerHTML += `
    <div class="card">
        <div class="title">
